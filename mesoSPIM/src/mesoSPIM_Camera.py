...
class mesoSPIM_Camera(QtCore.QObject):
    ...
    def __init__(self, parent = None):
        ...
        elif self.cfg.camera == 'PCOCamera':
...
class mesoSPIM_PCOCamera(mesoSPIM_GenericCamera):
    ...
    def open_camera(self):
        ...
        self.cam.sdk.set_cmos_line_timing('on', 75e-6) # 75 us delay
        self.cam.set_exposure_time(20e-3)
        # self.cam.sdk.set_cmos_line_exposure_delay(80, 0) # 266 lines = 20 ms / 75 us
        self.cam.configuration = {'trigger' : 'external exposure start & software trigger'}
